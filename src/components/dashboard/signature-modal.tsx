...
export function SignatureModal({ changeOrderId, orderNumber }: SignatureModalProps) {
  ...
  async function submitSignature() {
    ...
    setLoading(true);
    try {
      const res = await fetch(`/api/change-orders/${changeOrderId}/sign`, {
        method: "POST",
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle>Sign Change Order {orderNumber}</DialogTitle>
        </DialogHeader>
